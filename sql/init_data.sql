...
VALUES (1, 'user1', '63d2a85a8a2df3aac9047bc47864aa74', 'unionId1', 'mpOpenId1', 'user1',
        'https://www.code-nav.cn/logo.png', '喜欢编程的小白', 'user'),
       (2, 'user2', '63d2a85a8a2df3aac9047bc47864aa74', 'unionId2', 'mpOpenId2', 'user2',
        'https://www.code-nav.cn/logo.png', '全栈开发工程师', 'user'),
       (3, 'user3', '63d2a85a8a2df3aac9047bc47864aa74', 'unionId3', 'mpOpenId3', 'user3',
        'https://www.code-nav.cn/logo.png', '前端爱好者', 'user'),
       (4, 'user4', '63d2a85a8a2df3aac9047bc47864aa74', 'unionId4', 'mpOpenId4', 'user4',
        'https://www.code-nav.cn/logo.png', '后端开发工程师', 'user'),
       (5, 'xj', '63d2a85a8a2df3aac9047bc47864aa74', NULL, NULL, '程序员香蕉', 'https://www.code-nav.cn/logo.png',
        '系统管理员', 'admin');
